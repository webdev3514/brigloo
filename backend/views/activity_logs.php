                                ...
                                <div class="panel-body collapse" id="history_<?php  echo $job_value['in_job_id']; ?>">
                                    <ul class="ul-bo-list">
                                        ...
                                        foreach( $job_value['pickup'] as $pickup_key => $pickup_value ){ 
                                            ...
                                            ?>
                                            <li><p>Store manager added a change order request for store id: </p><span><?php echo $location_data['st_store_id']; ?> on the date of <?php echo date("m-d-Y", strtotime( $pickup_value['dt_created_at'] ) ); ?> at time <?php echo date("H:i:s", strtotime( $pickup_value['dt_created_at'] ) ); ?></span></li>
                                        <?php }else if(  $pickup_value['st_order_type'] != "bank" ){
                                             $location_data = $location->get_location( $pickup_value['in_location_id'] );
                                            $business_name = $user->get_user_data_by_key( $pickup_value['in_user_id'],'st_first_name' );
                                               ?>
                                            <li><p><?php echo $business_name; ?> added a pick up request for store id: </p><span><?php echo $location_data['st_store_id']; ?> on the date of <?php echo date("m-d-Y", strtotime( $pickup_value['dt_created_at'] ) ); ?> at time <?php echo date("H:i:s", strtotime( $pickup_value['dt_created_at'] ) ); ?></span></li>
                                        <?php 
                                            }
                                            if( isset( $pickup_value['st_order_type'] ) &&  $pickup_value['st_order_type'] == "change_order" ){
                                            $sm_bo_id =  $user->get_bo_data_by( 'in_user_id', $pickup_value['in_user_id'] );
                                            $business_name = $user->get_user_data_by_key( $sm_bo_id['in_user_id'],'st_first_name' );   
                                            ?>
                                            <li><p><?php echo $business_name; ?> Approved  the request of store Manager of the location: </p><span><?php echo $location_data['st_store_id']; ?> on the date of <?php echo date("m-d-Y", strtotime( $pickup_value['dt_created_at'] ) ); ?> at time <?php echo date("H:i:s", strtotime( $pickup_value['dt_created_at'] ) ); ?></span></li>
                                        <?php }
                                        }
                                        
                                        ?>
                                        <li><p>Admin assigned Trip to Driver on the date : </p><span> <?php echo date("m-d-Y", strtotime( $job_value['dt_created_at'] ) ); ?> at time <?php echo date("H:i:s", strtotime( $job_value['dt_created_at'] ) ); ?></span></li>
                                        <li><p>Driver Name:</p><span><?php echo $driver_name; ?></span></li>
                                        <li><p>Driver License No:</p><span><?php echo $license_no; ?></span></li>
                                        <li><p>Date & Time when trip assigned:</p><span><?php echo date("m-d-Y", strtotime( $job_value['dt_pickup'] ) ); ?></span></li>
                                        <li><p>Date & Time when trip start:</p><span><?php echo date("m-d-Y H:i:s", strtotime( $job_value['dt_start_time'] ) ); ?></span></li>
                                        <li><p>Date & Time when trip end:</p><span><?php echo date("m-d-Y H:i:s", strtotime( $job_value['dt_end_time'] ) ); ?></span></li>
                                    </ul>
                                    <div class="report_map" id="map_<?php echo $job_value['in_job_id']; ?>" data-job_id="<?php echo $job_value['in_job_id']; ?>"></div>
                                    <div class="table-responsive">
                                        <table id="pickup_report" class="table datatable pickup_report">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <!--<th>Location</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                if( isset( $job_value['pickup'] ) ){
                                                    ...
                                                    if( isset( $bank_data ) && $bank_data != '' || $bank_data > 0  ){
                                                        ...
                                                        <tr>
                                                            <td>0</td>
                                                            <td><?php echo $bank_data['st_type']; ?></td>
                                                            <td class="cut_location_address" title="<?php echo $bank_name; ?>"><?php echo $bank_name ?></td>
                                                            <td>-</td>
                                                            <td>-</td>
                                                            <td><?php echo date("m-d-Y", strtotime( $job_value['dt_pickup'] ) ); ?></td>
                                                    ...
                                                    foreach( $job_value['pickup'] as $pickup_key => $pickup_value ){ 
                                                        if( isset( $pickup_value ) && $pickup_value['st_order_type'] == 'bank' ){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo date("m-d-Y", strtotime( $pickup_value['dt_pickup'] ) ); ?></td>
                                                                <td><?php echo date("m-d-Y H:i:s", strtotime( $pickup_value['dt_start_time'] ) ); ?></td>
                                                                <td><?php echo date("m-d-Y H:i:s", strtotime( $pickup_value['dt_arrival_time'] ) ); ?></td>
                                                                <?php
                                                                if( $pickup_value['st_order_type'] == "change_order" ){
                                                                    ...
                                                                    <?php
                                                                }else if( $pickup_value['st_order_type'] != "bank" ){
                                                                ?>
                                                                    <td><?php echo date("H:i:s", strtotime( $pickup_value['dt_end_time'] ) ); ?></td>
                                                                    <td>-</td>
                                                                    <?php
                                                                ...
                                                                ?>
                                                                <td><?php echo date("m-d-Y H:i:s", strtotime( $pickup_value['dt_end_time'] ) ); ?></td>
                                                                <td><?php 

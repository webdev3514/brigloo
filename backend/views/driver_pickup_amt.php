                                        ...
                                        <tr class="job_<?php echo $value['in_job_id']; ?>">
                                            ...
                                            <td><?php 
                                                if( $value['st_pay_status'] == "pending" ){ ?>
                                                    <button class="btn btn-danger driver_pay_amount"  name="driver_pay_amount" data-job-id="<?php echo $value['in_job_id']; ?>">Pending</button>
                                                <?php } else { ?>
                                                    <label class="btn btn-danger paid_amt">Paid</label>
                                                <?php }?>
                                            </td>
                                        </tr>
                                        <?php
